...
if ($upload_acc['youtube_com']['user'] && $upload_acc['youtube_com']['pass']) {
    ...
    $auul['description'] = '';
    $auul['tags'] = ''; // Add tags like 'tag1, tag 2, tag3'
...
if ($_REQUEST['action'] == "FORM") $continue_up=true;
    ...
    echo "</select></td></tr>\n";
    echo "<tr><td style='white-space:nowrap;'>Privacy: <br /><select name='up_access' style='width:8em;height:20px;'><option value='private'>Private</option><option value='public'>Public</option><option value='unlisted'>Unlisted</option></select></td><td style='white-space:nowrap;'><input type='checkbox' name='up_embed' value='no' />&nbsp; Make video not embeddable</td></tr>";
