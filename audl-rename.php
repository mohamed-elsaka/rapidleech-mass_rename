...
if (isset($_REQUEST['GO']) && $_REQUEST['GO'] == 'GO') {
    ...
    if (isset($_REQUEST['server_side']) && $_REQUEST['server_side'] == 'on') {
        ...
        <table id="links" class="container" cellspacing="1">
            <thead>
            <tr>
                <td width="80%" align="left"><b><?php echo lang(21); ?></b></td>
                <td width="70" align="left"><b><?php echo lang(22); ?></b></td>
            </tr>
            </thead>
            <tfoot>
            <tr id="auto">
                <td colspan="2" align="center"><input type="button" value="<?php echo lang(29); ?>"
                                                      onclick="javascript:startauto();"/></td>
            </tr>
            </tfoot>
            <tbody>
            ...
            <td>
                <form action="?GO=GO" method="post">
                    <table align="center" width="700" border="0">
                        <tr id="menu">
                            <td width="700" align="center"><a
                                    href="javascript:ViewPage('listing');"><?php echo lang(32); ?></a>&nbsp;|&nbsp;<a
                                    href="javascript:ViewPage('options');"><?php echo lang(33); ?></a></td>
                        </tr>
                        <tr>
                                    ...
                                    <table cellspacing="5" style="width:710px;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <table align="center">
                                                    <tr>
                                                        <td><input type="checkbox" id="useproxy" name="useproxy"
                                                                   onclick="javascript:var displ=this.checked?'':'none';document.getElementById('proxy').style.display=displ;"<?php echo !empty($_COOKIE['useproxy']) ? ' checked="checked"' : ''; ?> />&nbsp;<?php echo lang(35); ?>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td id="proxy"<?php echo !empty($_COOKIE['useproxy']) ? '' : ' style="display: none;"'; ?>>
                                                            <table border="0">
                                                                <tr>
                                                                    ...
                                                                    <td><input name="proxy"
                                                                               size="25"<?php echo !empty($_COOKIE['roxy']) ? ' value="' . htmlentities($_COOKIE['proxy']) . '"' : ''; ?> />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><?php echo lang(37); ?>:</td>
                                                                    <td><input name="proxyuser"
                                                                               size="25"<?php echo !empty($_COOKIE['proxyuser']) ? ' value="' . htmlentities($_COOKIE['proxyuser']) . '"' : ''; ?> />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><?php echo lang(38); ?>:</td>
                                                                    <td><input name="proxypass"
                                                                               size="25"<?php echo !empty($_COOKIE['proxypass']) ? ' value="' . htmlentities($_COOKIE['proxypass']) . '"' : ''; ?> />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <?php if ($options['download_dir_is_changeable']) { ?>
                                                        <tr>
                                                            <td><input type="checkbox" name="saveto" id="saveto"
                                                                       onclick="javascript:var displ=this.checked?'':'none';document.getElementById('path').style.display=displ;"<?php echo !empty($_COOKIE['saveto']) ? ' checked="checked"' : ''; ?> />&nbsp;<?php echo lang(40); ?>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td id="path" <?php echo !empty($_COOKIE['saveto']) ? '' : ' style="display: none;"'; ?>><?php echo lang(41); ?>
                                                                :&nbsp;<input name="savedir" size="30"
                                                                              value="<?php echo(!empty($_COOKIE['savedir']) ? $_COOKIE['savedir'] : (substr($options['download_dir'], 0, 6) != 'ftp://' ? realpath(DOWNLOAD_DIR) : $options['download_dir'])); ?>"/>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                    <tr>
                                                        <td><input type="checkbox" value="on" name="premium_acc"
                                                                   id="premium_acc"
                                                                   onclick="javascript:var displ=this.checked?'':'none';document.getElementById('premiumblock').style.display=displ;"<?php if (count($premium_acc) > 0) echo ' checked="checked"'; ?> />&nbsp;<?php echo lang(42); ?>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td id="premiumblock" style="display: none;">
                                                            <table width="150" border="0">
                                                                <tr>
                                                                    <td><?php echo lang(37); ?>:&nbsp;</td>
                                                                    <td><input type="text" name="premium_user"
                                                                               id="premium_user" size="15" value=""/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><?php echo lang(38); ?>:&nbsp;</td>
                                                                    <td><input type="password" name="premium_pass"
                                                                               id="premium_pass" size="15" value=""/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="cookieuse"
                                                                   onclick="javascript:var displ=this.checked?'':'none';document.getElementById('cookieblock').style.display=displ;"/>&nbsp;<?php echo lang(235); ?>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td id="cookieblock" style="display: none;">
                                                            <table width="150" border="0">
                                                                <tr>
                                                                    <td><?php echo lang(236); ?>;</td>
                                                                    <td><input type="text" name="cookie" id="cookie"
                                                                               size="25" value=""/></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label><input type="checkbox" name="ytube_mp4"
                                                                          onclick="javascript:var displ=this.checked?'':'none';document.getElementById('ytubeopt').style.display=displ;"
                                                                          checked="checked"/>&nbsp;<?php echo lang(206); ?>
                                                            </label>
                                                            <table width="150" border="0" id="ytubeopt"
                                                                   style="display: none;">
                                                                <tr>
                                                                    <td>&nbsp;<label><input type="checkbox"
                                                                                            ...
                                                                                            checked="checked"
                                                                                            value="1"/>
                                                                            <small>&nbsp;Remove non-supported characters
                                                                                from filename
                                                                            </small>
                                                                        </label></td>
                                                                </tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="yt_fmt" id="yt_fmt">
                                                                            <option value="highest"
                                                                                    selected="selected"><?php echo lang(219); ?></option>
                                                                            <option value='22'>[22] Video: MP4 720p |
                                                                                Audio: AAC ~192 kbps
                                                                            </option>
                                                                            <option value='43'>[43] Video: WebM 360p |
                                                                                Audio: Vorbis ~128 kbps
                                                                            </option>
                                                                            <option value='18'>[18] Video: MP4 360p |
                                                                                Audio: AAC ~96 kbps
                                                                            </option>
                                                                            <option value='5'>[5] Video: FLV 240p |
                                                                                Audio: MP3 ~64 kbps
                                                                            </option>
                                                                            <option value='36'>[36] Video: 3GP 240p |
                                                                                Audio: AAC ~36 kbps
                                                                            </option>
                                                                            <option value='17'>[17] Video: 3GP 144p |
                                                                                Audio: AAC ~24 kbps
                                                                            </option>
                                                                        </select>
                                                                    </td>
